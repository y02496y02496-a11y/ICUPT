      ...
      <div className="bg-white border border-slate-200 w-full max-w-lg rounded-xl overflow-hidden shadow-2xl animate-scaleIn">
        ...
        <form onSubmit={handleSubmit} className="p-5 space-y-4">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-6 gap-2">
            <div>
              <label className="block text-[11px] font-bold text-slate-700 mb-1" htmlFor="pat-er-admission-input">入急診日期</label>
              <div className="relative">
            ...
            <div>
              <label className="block text-[11px] font-bold text-slate-700 mb-1" htmlFor="pat-reply-input">回覆照會</label>
              <div className="relative">
                <div className="absolute inset-y-0 left-0 pl-2 px-1 flex items-center pointer-events-none text-slate-400">
                  <Calendar className="w-3.5 h-3.5" />
                </div>
            ...
            <div>
              <label className="block text-[11px] font-bold text-slate-700 mb-1" htmlFor="pat-icu-discharge-input">轉出ICU</label>
              <div className="relative">
                <div className="absolute inset-y-0 left-0 pl-2 px-1 flex items-center pointer-events-none text-slate-400">
                  <Calendar className="w-3.5 h-3.5" />
                </div>
